...
{		
	...
	wp_register_script('mitsol_tw_feed_scroll_javascript', plugins_url('js/jquery.mCustomScrollbar.concat.min.js', __FILE__), array("jquery"), '1.1', true);
...
<div id="mstw-content-main-<?php echo $rnd_id; ?>" class="scroll-content"><div class="mstw-wall"><!-- tw plugin version1.1 --><?php echo $mstw_html_content_first; ?></div></div>  
</div> 
</div></div></div></div>
