...
== Description == 
Mitsol tweets displays fully customized tweets vertically and in slider for any user-tweets, hashtag-tweets, search-tweets using Twitter v1.1 REST API. It caches tweet data from twitter into database to deal with twitter Api request limit(read doc). 
...
= 1.1 =
Tested with latest wordpress version and other minor fixes